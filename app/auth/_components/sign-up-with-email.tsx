  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex w-full flex-col gap-3">
      <div className="flex flex-col gap-1">
        <input {...register("userName")} placeholder="Seu nome" className={inputClass} />
        {errors.userName && <p className="font-heading text-xs text-red-300 pl-3">{errors.userName.message}</p>}
      </div>
      <div className="flex flex-col gap-1">
